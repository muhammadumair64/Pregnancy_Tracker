...
import com.example.pregnancytrackerignite.databinding.SelectBreathingTimeBtmsheetBinding
...
class SelectBreathingTimeBottomSheet(
    private val onDone: (Int?) -> Unit
) : BottomSheetDialogFragment() {

    private val binding by lazy {
        SelectBreathingTimeBtmsheetBinding.inflate(layoutInflater)
    }
