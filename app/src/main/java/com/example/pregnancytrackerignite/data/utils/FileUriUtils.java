...
public class FileUriUtils {
     ...
     final String mEXTERNALSTORAGEDOC = "com.android.externalstorage.documents";
     final String mISDOWNLOADDOC = "com.android.providers.downloads.documents";
     final String mISMEDIADOC = "com.android.providers.media.documents";
     final String mISGOOGLEPHOTODOC = "com.google.android.apps.photos.content";
   ...
   public boolean isWhatsappImage(String uriAuthority) {
     ...
     boolean checkURIAuthority(Uri uri, String toCheckWith) {
        return toCheckWith.equals(uri.getAuthority());
    }

     boolean checkURI(Uri uri, String toCheckWith) {
     ...
     */
     boolean isDocumentUri(Context mContext, Uri uri) {
        boolean ret = false;
     ...
     String getURIForMediaDoc(ContentResolver mContentResolver, Uri uri) {
     ...
     String getURIForDownloadDoc(ContentResolver mContentResolver, Uri uri) {
        String documentId = DocumentsContract.getDocumentId(uri);
        // Build download uri.
     ...
     String getURIForExternalstorageDoc(Uri uri) {
        String documentId = DocumentsContract.getDocumentId(uri);
        String[] idArr = documentId.split(":");
        if (idArr.length == 2) {
            String type = idArr[0];
     ...
     String getUriForDocumentUri(ContentResolver mContentResolver, Uri uri) {
